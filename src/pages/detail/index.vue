<template>
  ...
  <view class="footer">
    <navigator :delta="1" open-type="navigateBack">
      <uni-icons type="arrow-left" :color="icon.color" :size="icon.size"></uni-icons>
    </navigator>
    <uni-icons type="download-filled" :size="icon.size" :color="icon.color" @click="handleDownloadWrapper"></uni-icons>
  </view>
</template>
